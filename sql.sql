...
SELECT SUM(opportunities.amount) AS total_revenue
FROM company
INNER JOIN company_partnership
    ON company.company_id = company_partnership.company_id
INNER JOIN campaigns
    ON company_partnership.partnership_id = campaigns.partnership_id
INNER JOIN leads
    ON campaigns.campaign_id = leads.campaign_id
INNER JOIN opportunities
    ON leads.lead_id = opportunities.lead_id
